...
Next, I removed two of the bottom-most phillips head screws from the front side of D2S projector to avoid interference with the retrofit bracket screws (after consulting the Lightwerkz video again).  Finally I threaded four #8 washers onto the top bolts behind the bracket and two on the lower bolts.  Per Lightwerkz, this allows the projector to be more closely aligned to OEM specs before any adjustments are made with the headlight screws themselves.  I then secured the projector to the housing and bolts using a final #8 washer between the projector and included lock nuts.  Tighten everything down one bolt at a time, taking care to close up the gaps between everything.

At this point the D2S projector is fully mounted to the OEM housing!  Congrats!
...
Before we reassemble everything, it's best to tackle the HID wiring.  This will mean everything is prepared for the headlights when it comes time to make adjustments and level the new D2S projectors.  For starters, lay out all of the packages included with the Retro-Quick kit:
